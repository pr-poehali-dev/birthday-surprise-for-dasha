...
const BirthdayWishes = () => {
  ...
  const wishes = [
    ...
    },
    {
      ...
      text: "Пусть жизнь дарит тебе удивительные путешествия, новые открытия и встречи с интересными людьми! Мир полон чудес!",
    },
    {
      title: "Пожелание творчества 🎨",
      text: "Желаю тебе вдохновения, креативности и возможности воплощать все свои самые смелые идеи в реальность!",
    },
    {
      title: "Пожелание здоровья 🌸",
      text: "Пусть каждый новый день дарит тебе энергию, бодрость и крепкое здоровье на долгие-долгие годы!",
    },
    {
      title: "Пожелание мечты 🌟",
      text: "Пусть все твои заветные мечты сбываются легко и естественно, как будто вселенная сама помогает тебе!",
    },
  ];
